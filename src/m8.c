/* m8.c -- Choplifter! for the IBM PCjr, milestone M8.
 *
 * DESIGN.md section 13: sound.  M7 combat plus SN76496 effects with
 * voice stealing (snd.c).  Effects only; no background music.  Ctrl-S
 * toggles like PREFS_SOUND.  No win-lose art (M9).
...
"HUD is Killed / Aboard / Rescued.  F1 or ` toggles the debug HUD\n"
"(off by default).  Sim is 20 Hz; the screen may\n"
...
int main(int argc, char **argv)
{
    ...
    printf("Choplifter! PCjr -- M8 sound\n");
    printf("SN76496 effects, voice stealing  ground %s\n\n",
           GROUND_COLOUR_NAME);
    ...
    printf("\nFlew with blit_rle_m8 + SN76496 on pages %d/%d.  Sim 20 Hz (every %u "
